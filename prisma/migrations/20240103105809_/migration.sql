...
-- CreateIndex
CREATE UNIQUE INDEX "BlockContent_id_key" ON "BlockContent"("id");
...
-- AddForeignKey
ALTER TABLE "BlockContent" ADD CONSTRAINT "BlockContent_campaignId_fkey" FOREIGN KEY ("campaignId") REFERENCES "Campaign"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BlockContent" ADD CONSTRAINT "BlockContent_promotionId_fkey" FOREIGN KEY ("promotionId") REFERENCES "Promotion"("id") ON DELETE SET NULL ON UPDATE CASCADE;
